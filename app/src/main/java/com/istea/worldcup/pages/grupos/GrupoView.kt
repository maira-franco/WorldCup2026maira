...
fun GruposView(
    ...
    Scaffold(
        ...
        Box(
            ...
            BackgroundImage()
            when (state) {
                GruposState.Cargando -> Cargando() //Primer cambio, le agrego el llamado a la funcion cargando
...
fun GroupCardView(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text(
                text = grupo.name, //tercer cambio, se corrigio string incorrecto
...
fun BackgroundImage() {
    Image(
        painter = painterResource(R.drawable.logo), //segundo cambio, se agrega el logo correcto
